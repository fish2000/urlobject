...
project = 'urlstring'
copyright = '2012, Zachary Voase / 2014, Alexander Bohn'
...
htmlhelp_basename = 'urlstringdoc'
...
texinfo_documents = [
  ('index', 'urlstring', 'urlstring Documentation',
   'Alexander Bohn', 'urlstring', 'One line description of project.',
   'Miscellaneous'),
]
